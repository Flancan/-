...
#define LOG_INFO(...) __android_log_print(ANDROID_LOG_INFO, "prozorova_ndk", __VA_ARGS__)

#include <spdlog/spdlog.h>
#include "spdlog/sinks/android_sink.h"

#define SLOG_INFO(...) android_logger->info( __VA_ARGS__ )
auto android_logger = spdlog::android_logger_mt( "android", "prozorova_ndk");
...
#include "C:/Users/missf/Desktop/PO_lab/libs/mbedtls/mbedtls/include/mbedtls/entropy.h"
#include "C:/Users/missf/Desktop/PO_lab/libs/mbedtls/mbedtls/include/mbedtls/ctr_drbg.h"
#include "C:/Users/missf/Desktop/PO_lab/libs/mbedtls/mbedtls/include/mbedtls/des.h"

mbedtls_entropy_context entropy;
mbedtls_ctr_drbg_context ctrDrbgContext;
std::string personalization = "prozorova-sample-app";

extern "C" JNIEXPORT jint JNICALL
Java_ru_iu3_prozorova_MainActivity_initRng(
        JNIEnv *env,
        jclass clazz ) {
...
Java_ru_iu3_prozorova_MainActivity_randomBytes(
        JNIEnv *env,
        jclass clazz,
        jint n ) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_prozorova_MainActivity_encrypt(
        JNIEnv *env,
        jclass clazz,
        jbyteArray key,
        jbyteArray data ) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_prozorova_MainActivity_decrypt(
        JNIEnv *env,
        jclass clazz,
        jbyteArray key,
        jbyteArray data ) {
